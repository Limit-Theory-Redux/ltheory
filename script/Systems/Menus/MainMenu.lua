...
function MainMenu:ShowGui()
    ...
    HmGuiInstance:textEx(Cache.Font('RajdhaniSemiBold', 72 * scalefactor), 'LIMIT THEORY', 0.2, 0.2, 0.2, 1.0)
    HmGuiInstance:setAlign(0.031, 0.042)
    HmGuiInstance:textEx(Cache.Font('RajdhaniSemiBold', 72 * scalefactor), 'LIMIT THEORY', 0.9, 0.9, 0.9, 1.0)
    HmGuiInstance:setAlign(0.03, 0.04)
    HmGuiInstance:textEx(Cache.Font('RajdhaniSemiBold', 58 * scalefactor), 'REDUX', 0.2, 0.2, 0.2, 1.0)
    HmGuiInstance:setAlign(0.181, 0.132)
    HmGuiInstance:textEx(Cache.Font('RajdhaniSemiBold', 58 * scalefactor), 'REDUX', 0.9, 0.9, 0.9, 1.0)
    HmGuiInstance:setAlign(0.18, 0.13)

    HmGuiInstance:textEx(Cache.Font('RajdhaniSemiBold', 12 * scalefactor), Config.gameVersion, 0.2, 0.2, 0.2, 1.0)
    HmGuiInstance:setAlign(0.012, 0.971)
    HmGuiInstance:textEx(Cache.Font('RajdhaniSemiBold', 12 * scalefactor), Config.gameVersion, 0.9, 0.9, 0.9, 1.0)
    HmGuiInstance:setAlign(0.011, 0.970)

    HmGuiInstance:textEx(Cache.Font('RajdhaniSemiBold', 12 * scalefactor),
        'Resolution = ' .. LTheoryRedux.resX .. ' x ' .. LTheoryRedux.resY, 0.2, 0.2, 0.2, 1.0)
    HmGuiInstance:setAlign(0.221, 0.971)
    HmGuiInstance:textEx(Cache.Font('RajdhaniSemiBold', 12 * scalefactor),
        'Resolution = ' .. LTheoryRedux.resX .. ' x ' .. LTheoryRedux.resY, 0.9, 0.9, 0.9, 1.0)
    HmGuiInstance:setAlign(0.220, 0.970)

    self:ShowMainMenuInner()

    HmGuiInstance:setStretch(0.18, 0.5)
    HmGuiInstance:setAlign(0.0065, 0.8)
...
function MainMenu:ShowMainMenuInner()
    ...
    HmGuiInstance:pushTextColor(0.9, 0.9, 0.9, 1.0)
    HmGuiInstance:pushFont(Cache.Font('RajdhaniSemiBold', 36 * scalefactor))

    if HmGuiInstance:button("NEW GAME") then
        self:ShowSeedDialog()
    end

    if HmGuiInstance:button("LOAD GAME") then
        self:ShowSeedDialog()
    end

    if HmGuiInstance:button("SETTINGS") then
        self:ShowSettingsScreen()
    end

    if HmGuiInstance:button("CREDITS") then
    end

    if HmGuiInstance:button("BACKGROUND") then
        self:SetBackgroundMode(true)
    end

    if HmGuiInstance:button("EXIT GAME") then
...
function MainMenu:ShowSeedDialog()
    ...
    HmGuiInstance:beginWindow(guiElements.name, InputInstance)
    HmGuiInstance:textEx(Cache.Font('Iceland', 42), 'Choose Seed', 0.3, 0.6, 1.0, 1.0)
...
function MainMenu:ShowSeedDialogInner()
    ...
    HmGuiInstance:pushFont(Cache.Font('Exo2', 26))
    ...
    for i = 1, #guiElements[1]["elems"] do
        ...
        guiElements[1]["elems"][i][3] = HmGuiInstance:checkbox(tostring(guiElements[1]["elems"][i][2]),
    ...
    HmGuiInstance:pushTextColor(1.0, 1.0, 1.0, 1.0)
    HmGuiInstance:pushFont(Cache.Font('Exo2Bold', 28))
    ...
    if HmGuiInstance:button("Random Seed") then
    ...
    if HmGuiInstance:button("Use Seed") then
        self.seedDialogDisplayed = false
...
function MainMenu:ShowSettingsScreen()
    ...
    HmGuiInstance:beginWindow(guiElements.name, InputInstance)
    HmGuiInstance:textEx(Cache.Font('Iceland', 42), 'Settings', 0.3, 0.6, 1.0, 1.0)
    HmGuiInstance:setAlign(0.5, 0.5)
    HmGuiInstance:rect(1.0, 1.0, 0.3, 0.6, 1.0, 1.0)
    HmGuiInstance:setStretch(1.0, 0.5)
    HmGuiInstance:setSpacing(16)
...
function MainMenu:ShowSettingsScreenInner()
    ...
    HmGuiInstance:beginGroupY()
    HmGuiInstance:pushTextColor(1.0, 1.0, 1.0, 1.0)
    HmGuiInstance:pushFont(Cache.Font('Exo2', 24))

    -- Show Settings options
    HmGuiInstance:beginGroupY()

    HmGuiInstance:textEx(Cache.Font('Exo2', 24), "--- Audio ---", 0.3, 0.6, 1.0, 1.0)
    ...
    guiSettings[1][1] = HmGuiInstance:checkbox(guiSettings[1][3], guiSettings[1][1])
    ...
    HmGuiInstance:setSpacing(16)
    HmGuiInstance:textEx(Cache.Font('Exo2', 24), "--- Graphics ---", 0.3, 0.6, 1.0, 1.0)
    HmGuiInstance:setStretch(0.0, 0.0)
    HmGuiInstance:setAlign(0.5, 0.5)
    ...
    guiSettings[2][1] = HmGuiInstance:checkbox(guiSettings[2][3], guiSettings[2][1])
    ...
    HmGuiInstance:setSpacing(8)
    HmGuiInstance:beginGroupX()
    HmGuiInstance:textEx(Cache.Font('Exo2', 24), guiSettings[3][3], 1.0, 1.0, 1.0, 1.0)
    ...
    if HmGuiInstance:button("-") and guiSettings[3][1] > 1 then
        guiSettings[3][1] = guiSettings[3][1] - 1
        Settings.set('render.superSample', guiSettings[3][1])
    end
    HmGuiInstance:textEx(Cache.Font("Ubuntu", 20), Settings.getEnumValName('render.superSample', guiSettings[3][1]), 0.3, 1.0,
        0.4, 1.0)
    if HmGuiInstance:button("+") and guiSettings[3][1] < 3 then
        guiSettings[3][1] = guiSettings[3][1] + 1
        Settings.set('render.superSample', guiSettings[3][1])
    end
    HmGuiInstance:endGroup()
    ...
    HmGuiInstance:setSpacing(8)
    HmGuiInstance:beginGroupX()
    HmGuiInstance:textEx(Cache.Font('Exo2', 24), guiSettings[4][3], 1.0, 1.0, 1.0, 1.0)
    HmGuiInstance:setStretch(1.0, 0.0)
    HmGuiInstance:beginGroupX()
    ...
    if HmGuiInstance:button("-") and guiSettings[4][1] > 0.25 then
        guiSettings[4][1] = guiSettings[4][1] - 0.25
    end
    HmGuiInstance:textEx(Cache.Font("Ubuntu", 20), tostring(guiSettings[4][1]), 0.3, 1.0, 0.4, 1.0)
    if HmGuiInstance:button("+") and guiSettings[4][1] < 10 then
        guiSettings[4][1] = guiSettings[4][1] + 0.25
    end
    HmGuiInstance:endGroup()
    HmGuiInstance:endGroup()
    ...
    HmGuiInstance:setSpacing(16)
    HmGuiInstance:textEx(Cache.Font('Exo2', 24), "--- Interface ---", 0.3, 0.6, 1.0, 1.0)
    HmGuiInstance:setStretch(0.0, 0.0)
    HmGuiInstance:setAlign(0.5, 0.5)

    HmGuiInstance:setSpacing(8)
    HmGuiInstance:beginGroupX()
    HmGuiInstance:textEx(Cache.Font('Exo2', 24), guiSettings[5][3], 1.0, 1.0, 1.0, 1.0)
    HmGuiInstance:setStretch(1.0, 0.0)
    HmGuiInstance:beginGroupX()
    ...
    if HmGuiInstance:button("-") and guiSettings[5][1] > 1 then
    ...
    HmGuiInstance:textEx(Cache.Font("Ubuntu", 20), Enums.CursorStyleNames[guiSettings[5][1]], 0.3, 1.0, 0.4, 1.0)
    if HmGuiInstance:button("+") and guiSettings[5][1] < Enums.CursorStyleCount then
        guiSettings[5][1] = guiSettings[5][1] + 1
        LTheoryRedux:setCursor(Enums.CursorFilenames[guiSettings[5][1]], GameState.ui.cursorX, GameState.ui.cursorY)
    end
    HmGuiInstance:endGroup()
    ...
    HmGuiInstance:setSpacing(8)
    HmGuiInstance:beginGroupX()
    HmGuiInstance:textEx(Cache.Font('Exo2', 24), guiSettings[6][3], 1.0, 1.0, 1.0, 1.0)
    HmGuiInstance:setStretch(1.0, 0.0)
    HmGuiInstance:beginGroupX()
    ...
    if HmGuiInstance:button("-") and guiSettings[6][1] > 1 then
        guiSettings[6][1] = guiSettings[6][1] - 1
    end
    HmGuiInstance:textEx(Cache.Font("Ubuntu", 20), Enums.HudStyleNames[guiSettings[6][1]], 0.3, 1.0, 0.4, 1.0)
    if HmGuiInstance:button("+") and guiSettings[6][1] < Enums.HudStyleCount then
        guiSettings[6][1] = guiSettings[6][1] + 1
    end
    HmGuiInstance:endGroup()
    HmGuiInstance:endGroup()
    ...
    if MainMenu.currentMode ~= Enums.MenuMode.Dialog then
        ...
        HmGuiInstance:setSpacing(16)
        HmGuiInstance:textEx(Cache.Font('Exo2', 24), "--- Generation ---", 0.3, 0.6, 1.0, 1.0)
        HmGuiInstance:setStretch(0.0, 0.0)
        HmGuiInstance:setAlign(0.5, 0.5)
        ...
        guiSettings[7][1] = HmGuiInstance:checkbox(guiSettings[7][3], guiSettings[7][1])
        ...
        HmGuiInstance:setSpacing(8)
        HmGuiInstance:beginGroupX()
        HmGuiInstance:textEx(Cache.Font('Exo2', 24), guiSettings[8][3], 1.0, 1.0, 1.0, 1.0)
        HmGuiInstance:setStretch(1.0, 0.0)
        HmGuiInstance:beginGroupX()
        ...
        if HmGuiInstance:button("-") and guiSettings[8][1] > 0 then
            guiSettings[8][1] = guiSettings[8][1] - 1
        end
        HmGuiInstance:textEx(Cache.Font("Ubuntu", 20), tostring(guiSettings[8][1]), 0.3, 1.0, 0.4, 1.0)
        if HmGuiInstance:button("+") and guiSettings[8][1] < 20 then
            guiSettings[8][1] = guiSettings[8][1] + 1
        end
        HmGuiInstance:endGroup()
        HmGuiInstance:endGroup()
        ...
        HmGuiInstance:setSpacing(8)
        HmGuiInstance:beginGroupX()
        HmGuiInstance:textEx(Cache.Font('Exo2', 24), guiSettings[9][3], 1.0, 1.0, 1.0, 1.0)
        HmGuiInstance:setStretch(1.0, 0.0)
        HmGuiInstance:beginGroupX()
        ...
        if HmGuiInstance:button("-") and guiSettings[9][1] > 1 then
            guiSettings[9][1] = guiSettings[9][1] - 1
        end
        HmGuiInstance:textEx(Cache.Font("Ubuntu", 20), tostring(guiSettings[9][1]), 0.3, 1.0, 0.4, 1.0)
        if HmGuiInstance:button("+") and guiSettings[9][1] < 200 then
            guiSettings[9][1] = guiSettings[9][1] + 1
        end
        HmGuiInstance:endGroup()
        HmGuiInstance:endGroup()
        ...
        HmGuiInstance:setSpacing(8)
        HmGuiInstance:beginGroupX()
        HmGuiInstance:textEx(Cache.Font('Exo2', 24), guiSettings[10][3], 1.0, 1.0, 1.0, 1.0)
        HmGuiInstance:setStretch(1.0, 0.0)
        HmGuiInstance:beginGroupX()
        ...
        if HmGuiInstance:button("-") and guiSettings[10][1] > 0 then
            guiSettings[10][1] = guiSettings[10][1] - 1
        end
        HmGuiInstance:textEx(Cache.Font("Ubuntu", 20), tostring(guiSettings[10][1]), 0.3, 1.0, 0.4, 1.0)
        if HmGuiInstance:button("+") and guiSettings[10][1] < 1 then
            guiSettings[10][1] = guiSettings[10][1] + 1
        end
        HmGuiInstance:endGroup()
        HmGuiInstance:endGroup()
        ...
        HmGuiInstance:setSpacing(8)
        HmGuiInstance:beginGroupX()
        HmGuiInstance:textEx(Cache.Font('Exo2', 24), guiSettings[11][3], 1.0, 1.0, 1.0, 1.0)
        HmGuiInstance:setStretch(1.0, 0.0)
        HmGuiInstance:beginGroupX()
        ...
        if HmGuiInstance:button("-") and guiSettings[11][1] > 0 then
            guiSettings[11][1] = guiSettings[11][1] - 1
        end
        HmGuiInstance:textEx(Cache.Font("Ubuntu", 20), tostring(guiSettings[11][1]), 0.3, 1.0, 0.4, 1.0)
        if HmGuiInstance:button("+") and guiSettings[11][1] < 50 then
            guiSettings[11][1] = guiSettings[11][1] + 1
        end
        HmGuiInstance:endGroup()
        HmGuiInstance:endGroup()
        ...
        HmGuiInstance:setSpacing(8)
        HmGuiInstance:beginGroupX()
        HmGuiInstance:textEx(Cache.Font('Exo2', 24), guiSettings[12][3], 1.0, 1.0, 1.0, 1.0)
        HmGuiInstance:setStretch(1.0, 0.0)
        HmGuiInstance:beginGroupX()
        ...
        if HmGuiInstance:button("-") and guiSettings[12][1] > 0 then
            guiSettings[12][1] = guiSettings[12][1] - 1
        end
        HmGuiInstance:textEx(Cache.Font("Ubuntu", 20), tostring(guiSettings[12][1]), 0.3, 1.0, 0.4, 1.0)
        if HmGuiInstance:button("+") and guiSettings[12][1] < 20 then
            guiSettings[12][1] = guiSettings[12][1] + 1
        end
        HmGuiInstance:endGroup()
        HmGuiInstance:endGroup()
        ...
        HmGuiInstance:setSpacing(8)
        HmGuiInstance:beginGroupX()
        HmGuiInstance:textEx(Cache.Font('Exo2', 24), guiSettings[13][3], 1.0, 1.0, 1.0, 1.0)
        HmGuiInstance:setStretch(1.0, 0.0)
        HmGuiInstance:beginGroupX()
        ...
        if HmGuiInstance:button("-") and guiSettings[13][1] > 0 then
            guiSettings[13][1] = guiSettings[13][1] - 1
        end
        HmGuiInstance:textEx(Cache.Font("Ubuntu", 20), tostring(guiSettings[13][1]), 0.3, 1.0, 0.4, 1.0)
        if HmGuiInstance:button("+") and guiSettings[13][1] < 100 then
            guiSettings[13][1] = guiSettings[13][1] + 1
        end
        HmGuiInstance:endGroup()
        HmGuiInstance:endGroup()
        ...
        HmGuiInstance:setSpacing(8)
        HmGuiInstance:beginGroupX()
        HmGuiInstance:textEx(Cache.Font('Exo2', 24), guiSettings[14][3], 1.0, 1.0, 1.0, 1.0)
        HmGuiInstance:setStretch(1.0, 0.0)
        HmGuiInstance:beginGroupX()
        ...
        if HmGuiInstance:button("-") and guiSettings[14][1] > 0 then
            guiSettings[14][1] = guiSettings[14][1] - 1
        end
        HmGuiInstance:textEx(Cache.Font("Ubuntu", 20), tostring(guiSettings[14][1]), 0.3, 1.0, 0.4, 1.0)
        if HmGuiInstance:button("+") and guiSettings[14][1] < 50 then
            guiSettings[14][1] = guiSettings[14][1] + 1
        end
        HmGuiInstance:endGroup()
        HmGuiInstance:endGroup()
        ...
        HmGuiInstance:setSpacing(8)
        HmGuiInstance:beginGroupX()
        HmGuiInstance:textEx(Cache.Font('Exo2', 24), guiSettings[15][3], 1.0, 1.0, 1.0, 1.0)
        HmGuiInstance:setStretch(1.0, 0.0)
        HmGuiInstance:beginGroupX()
        ...
        if HmGuiInstance:button("-") and guiSettings[15][1] > Enums.ShipHulls.Solo then
            guiSettings[15][1] = guiSettings[15][1] - 1
        end
        local hullSizeName = Config:getObjectInfo("ship_subtypes", 3 + (guiSettings[15][1] - 1))
        HmGuiInstance:textEx(Cache.Font("Ubuntu", 20), hullSizeName, 0.3, 1.0, 0.4, 1.0)

        if HmGuiInstance:button("+") and guiSettings[15][1] < Enums.ShipHulls.VeryLarge then
            guiSettings[15][1] = guiSettings[15][1] + 1
        end
        HmGuiInstance:endGroup()
        HmGuiInstance:endGroup()
    ...
    if HmGuiInstance:button("Use") then
...
function MainMenu:ShowFlightDialog()
    ...
    HmGuiInstance:beginWindow("Flight Mode", InputInstance)
    HmGuiInstance:textEx(Cache.Font('Iceland', 36), 'Flight Mode Controls', 0.3, 0.6, 1.0, 1.0)
    HmGuiInstance:setAlign(0.5, 0.5)
    HmGuiInstance:setSpacing(16)
...
function MainMenu:ShowFlightDialogInner()
    ...
    if GameState.player.currentShip ~= nil and not GameState.player.currentShip:isDestroyed() then
        ...
        if HmGuiInstance:button("Save Game") then
    ...
    if HmGuiInstance:button("Game Settings") then
    ...
    if HmGuiInstance:button("Exit to Main Menu") then
