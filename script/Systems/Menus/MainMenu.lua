...
function MainMenu:ShowGui()
    ...
    -- Title
    Gui:setProperty(GuiProperties.BorderColor, GuiPropertyValue.FromColor(Color(1.0, 1.0, 1.0, 1.0)))
    ...
    Gui:setProperty(GuiProperties.BackgroundColor, GuiPropertyValue.FromColor(Color(0.1, 0.1, 0.1, 0.5)))
    Gui:beginVerticalContainer() -- begin changelog text panel
    Gui:setPercentHeight(80)
    Gui:setSpacing(0)

    Gui:setProperty(GuiProperties.BackgroundColor, GuiPropertyValue.FromColor(Color(0.2, 0.2, 0.2, 0.3)))
...
function MainMenu:ShowMainMenuInner()
    ...
    Gui:setProperty(GuiProperties.TextFont, GuiPropertyValue.FromFont(Cache.Font('RajdhaniSemiBold', 36 * scaleFactor)))
...
function MainMenu:ShowSeedDialog()
    ...
    Gui:setProperty(GuiProperties.BackgroundColor, GuiPropertyValue.FromColor(Color(0, 0, 0, 0)))
...
function MainMenu:ShowSettingsScreen()
    ...
    -- Separator
    Gui:setProperty(GuiProperties.BackgroundColor, GuiPropertyValue.FromColor(Color(0.3, 0.6, 1.0, 1.0)))
