        ...
        :add(UI.Collapsible('UI')
            :add(UI.Grid():setCols(1):setPad(2, 0, 2, 2)
                ...
                :add(uiDebugGrid:setPadCellX(8)
                    ...
                    --:add(UI.Label():setPollFn(function () local d = ffi.new('Device') Input:activeDevice(d) return d end))
                    :add(UI.Label('Active Device Type'))
                    :add(UI.Label():setPollFn(function() return Input:activeDeviceType() end))
                    :add(UI.Label('Active Device ID'))
                    :add(UI.Label():setPollFn(function() return Input:activeDeviceId() end))
                )
            )
        )
end
