    ...
    return UI.NavGroup()
        :add(UI.Collapsible('Audio')
            :add(UI.Grid():setPad(2, 0, 2, 2):setPadCellX(8)
                ...
                :add(UI.Label():setPollFn(LTheoryRedux.audio:getLoadedCount()))
                :add(UI.Label('Total Sounds'))
                :add(UI.Label():setPollFn(LTheoryRedux.audio:getTotalCount()))
                :add(UI.Label('Playing Sounds'))
                :add(UI.Label():setPollFn(LTheoryRedux.audio:getPlayingCount()))
            )
        )
end
