...
function CommandControl:onInput(state)
    ...
    if remove then
        self.selectionMode = SelectionMode.Remove
    elseif toggle then
        self.selectionMode = SelectionMode.Toggle
    elseif append then
        self.selectionMode = SelectionMode.Add
    else
        self.selectionMode = SelectionMode.Replace
    end
...
function CommandControl.Create(gameView, player)
    local self = setmetatable({
        ...
        units         = Systems.CommandView.TrackingList(player, Entity.isAlive),
        unitRects     = List(),
        unitNDCs      = List(),
        unitGroups    = {
