...
Item.ShipSensor    = Item("Ship Sensor",                      500,  19.00)
Item.ShipComputer  = Item("Ship Computer",                    500,  22.00)
Item.EngineThrust  = Item("Ship Engine, Thruster",            500,  20.00)
Item.EngineImpel   = Item("Ship Engine, Impeller",           1500,  18.00)
Item.WeaponTPulse  = Item("Ship Weapon, Pulse Turret",        100,  10.00)
Item.WeaponTBeam   = Item("Ship Weapon, Beam Turret",         120,  10.00)
Item.WeaponTLaunch = Item("Ship Weapon, Launcher Turret",      90,   8.00)
Item.WeaponBPulse  = Item("Ship Weapon, Pulse Bay",          1000,   9.00)
Item.WeaponBBeam   = Item("Ship Weapon, Beam Bay",           1200,   9.00)
Item.WeaponBCannon = Item("Ship Weapon, Cannon Bay",         2500,  10.00)
Item.WeaponBLaunch = Item("Ship Weapon, Launcher Bay",        800,   7.00)
Item.ShipSolo      = Item("Ship Hull, Solo",                15000,  50.00)
Item.ShipSmall     = Item("Ship Hull, Small",               32000,  49.00)
Item.ShipCompact   = Item("Ship Hull, Compact",             75000,  47.00)
Item.ShipMedium    = Item("Ship Hull, Medium",             102500,  46.00)
Item.ShipLarge     = Item("Ship Hull, Large",              237250,  45.00)
Item.ShipVLarge    = Item("Ship Hull, Very Large",         518000,  42.00)
...
insert(Item.T6, Item.EngineImpeller)
insert(Item.T6, Item.EngineImpeller)
...
Production.ShipSolo = Production('Solo Ship Hull Drydock')
  ...
  :addInput(Item.EngineThruster, 1)
