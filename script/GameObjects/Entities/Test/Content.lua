...
Item.Silicates     = Item("Silicate Ore",                       4,   0.30, 0.30)
Item.Chondrites    = Item("Carboniferous Ore",                  7,   1.40, 0.19)
Item.WaterIce      = Item("Water Ice",                          8,   0.50, 0.13)
Item.BerylliumOre  = Item("Beryllium Ore",                      9,   0.45, 0.11)
Item.AluminumOre   = Item("Aluminum Ore",                       7,   0.60, 0.09)
Item.IronOre       = Item("Iron Ore",                          10,   0.68, 0.08)
Item.CopperOre     = Item("Copper Ore",                        11,   0.74, 0.06)
Item.ThoriumOre    = Item("Thorium Ore",                       19,   3.50, 0.04)
Item.Biomass       = Item("Biomass",                            8,   5.00, 0.00)
Item.Hydrogen      = Item("Hydrogen",                           1,   2.00, 1.00)
Item.Helium        = Item("Helium",                             1,   0.01, 1.00)
Item.Lithium       = Item("Lithium",                            1,   0.20, 1.00)
Item.Beryllium     = Item("Beryllium",                          2,   0.30, 1.00)
Item.Boron         = Item("Boron",                              2,   0.20, 1.00)
Item.Carbon        = Item("Carbon",                             2,   0.30, 1.00)
Item.Nitrogen      = Item("Nitrogen",                           1,   0.05, 1.00)
Item.Oxygen        = Item("Oxygen",                             1,   2.00, 1.00)
Item.Aluminum      = Item("Aluminum",                           3,   0.80, 1.00)
Item.Silicon       = Item("Silicon",                            2,   0.60, 1.00)
...
Item.Waste         = Item("Waste",                              2,   0.50, 1.00)
Item.WaterLiquid   = Item("Liquid Water",                      10,   0.80, 1.00)
Item.Steel         = Item("Steel",                              7,   1.00, 1.00)
Item.Isotopes      = Item("Radioactive Isotopes",              24,  50.00, 1.00)
Item.AnodeSludge   = Item("Anode Sludge",                      10,   0.90, 1.00)
Item.Petroleum     = Item("Petroleum",                          6,   3.50, 1.00)
Item.Plastic       = Item("Plastic",                            4,   1.90, 1.00)
Item.Infolytic     = Item("Infolytic Chip",                     5,   1.35, 1.00)
Item.Glassiron     = Item("Glassiron",                         12,   1.00, 1.00)
Item.TranspAlum    = Item("Transparent Aluminum",               7,   1.70, 1.00)
Item.WasteRad      = Item("Radioactive Waste",                 15,   2.50, 1.00)
Item.ShipSensor    = Item("Ship Sensor",                      500,  19.00, 1.00)
Item.ShipComputer  = Item("Ship Computer",                    500,  22.00, 1.00)
Item.EngineThrust  = Item("Ship Engine, Thruster",            500,  20.00, 1.00)
...
Item.Station       = Item("Space Station",                1550000,  40.00, 1.00)
