...
local LifeSupport
LifeSupport = subclass(Entity, function (self)
...
--printf("Register: Sensor name = '%s', type = %s, handler = %s", self.name, Event.Update, LifeSupport.updateLifeSupport)
  self:register(Event.Update, LifeSupport.updateLifeSupport)
end)
