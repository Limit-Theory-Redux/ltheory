...
function Loader.defineType()
    ...
    do -- C Definitions
        ffi.cdef [[
            ...
            Box3f   Matrix_MulBox             (Matrix const*, Box3f const* in0);
            Vec3f   Matrix_MulDir             (Matrix const*, Vec3f const* d);
            Vec3f   Matrix_MulPoint           (Matrix const*, Vec3f const* p);
            Vec4f   Matrix_MulVec             (Matrix const*, Vec4f const* v);
            Vec3f   Matrix_GetForward         (Matrix const*);
            Vec3f   Matrix_GetRight           (Matrix const*);
            Vec3f   Matrix_GetUp              (Matrix const*);
            Vec3f   Matrix_GetPos             (Matrix const*);
            Vec4f   Matrix_GetRow             (Matrix const*, int row);
