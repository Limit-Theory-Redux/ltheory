...
function Loader.defineType()
    ...
    do -- C Definitions
        ffi.cdef [[
            ...
            void Profiler_RequestToggle ();
            bool Profiler_PendingToggle ();
    ...
    do -- Global Symbol Table
        Profiler = {
            IsEnabled     = libphx.Profiler_IsEnabled,
            RequestToggle = libphx.Profiler_RequestToggle,
            PendingToggle = libphx.Profiler_PendingToggle,
