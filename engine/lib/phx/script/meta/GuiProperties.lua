...
GuiProperties = {
    ...
    ---Default value: true
    ScrollAreaScrollbarVisibilityFading = 36,
    ...
    ---Default value: Color :: new(0.1, 0.1, 0.1, 0.5)
    ScrollAreaScrollbarKnobColor = 39,
}
