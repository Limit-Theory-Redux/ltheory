...
pub extern "C" fn Button_ToDeviceType(button: Button) -> DeviceType {
    if button == Button_Null {
        ...
        Fatal!("Button_ToDeviceType: Unknown Button: {button}");
    }
}
...
pub fn button_to_string(button: Button) -> String {
    match button {
        ...
        8 => "Button_Keyboard_H",
        9 => "Button_Keyboard_I",
        10 => "Button_Keyboard_J",
        11 => "Button_Keyboard_K",
        12 => "Button_Keyboard_L",
        13 => "Button_Keyboard_M",
        14 => "Button_Keyboard_N",
        15 => "Button_Keyboard_O",
        16 => "Button_Keyboard_P",
        17 => "Button_Keyboard_Q",
        18 => "Button_Keyboard_R",
        19 => "Button_Keyboard_S",
        20 => "Button_Keyboard_T",
        21 => "Button_Keyboard_U",
        22 => "Button_Keyboard_V",
        23 => "Button_Keyboard_W",
        24 => "Button_Keyboard_X",
        25 => "Button_Keyboard_Y",
        26 => "Button_Keyboard_Z",
        27 => "Button_Keyboard_N0",
        28 => "Button_Keyboard_N1",
        29 => "Button_Keyboard_N2",
        30 => "Button_Keyboard_N3",
        31 => "Button_Keyboard_N4",
        32 => "Button_Keyboard_N5",
        33 => "Button_Keyboard_N6",
        34 => "Button_Keyboard_N7",
        35 => "Button_Keyboard_N8",
        36 => "Button_Keyboard_N9",
        37 => "Button_Keyboard_F1",
        38 => "Button_Keyboard_F2",
        39 => "Button_Keyboard_F3",
        40 => "Button_Keyboard_F4",
        41 => "Button_Keyboard_F5",
        42 => "Button_Keyboard_F6",
        43 => "Button_Keyboard_F7",
        44 => "Button_Keyboard_F8",
        45 => "Button_Keyboard_F9",
        46 => "Button_Keyboard_F10",
        47 => "Button_Keyboard_F11",
        48 => "Button_Keyboard_F12",
        49 => "Button_Keyboard_F13",
        50 => "Button_Keyboard_F14",
        51 => "Button_Keyboard_F15",
        52 => "Button_Keyboard_F16",
        53 => "Button_Keyboard_F17",
        54 => "Button_Keyboard_F18",
        55 => "Button_Keyboard_F19",
        56 => "Button_Keyboard_F20",
        57 => "Button_Keyboard_F21",
        58 => "Button_Keyboard_F22",
        59 => "Button_Keyboard_F23",
        60 => "Button_Keyboard_F24",
        61 => "Button_Keyboard_KP0",
        62 => "Button_Keyboard_KP1",
        63 => "Button_Keyboard_KP2",
        64 => "Button_Keyboard_KP3",
        65 => "Button_Keyboard_KP4",
        66 => "Button_Keyboard_KP5",
        67 => "Button_Keyboard_KP6",
        68 => "Button_Keyboard_KP7",
        69 => "Button_Keyboard_KP8",
        70 => "Button_Keyboard_KP9",
        71 => "Button_Keyboard_KPNumLock",
        72 => "Button_Keyboard_KPDivide",
        73 => "Button_Keyboard_KPMultiply",
        74 => "Button_Keyboard_KPSubtract",
        75 => "Button_Keyboard_KPAdd",
        76 => "Button_Keyboard_KPEnter",
        77 => "Button_Keyboard_KPDecimal",
        78 => "Button_Keyboard_Backspace",
        79 => "Button_Keyboard_Escape",
        80 => "Button_Keyboard_Return",
        81 => "Button_Keyboard_Space",
        82 => "Button_Keyboard_Tab",
        83 => "Button_Keyboard_Backtick",
        84 => "Button_Keyboard_CapsLock",
        85 => "Button_Keyboard_Minus",
        86 => "Button_Keyboard_Equals",
        87 => "Button_Keyboard_LBracket",
        88 => "Button_Keyboard_RBracket",
        89 => "Button_Keyboard_Backslash",
        90 => "Button_Keyboard_Semicolon",
        91 => "Button_Keyboard_Apostrophe",
        92 => "Button_Keyboard_Comma",
        93 => "Button_Keyboard_Period",
        94 => "Button_Keyboard_Slash",
        95 => "Button_Keyboard_PrintScreen",
        96 => "Button_Keyboard_ScrollLock",
        97 => "Button_Keyboard_Pause",
        98 => "Button_Keyboard_Insert",
        99 => "Button_Keyboard_Delete",
        100 => "Button_Keyboard_Home",
        101 => "Button_Keyboard_End",
        102 => "Button_Keyboard_PageUp",
        103 => "Button_Keyboard_PageDown",
        104 => "Button_Keyboard_Right",
        105 => "Button_Keyboard_Left",
        106 => "Button_Keyboard_Down",
        107 => "Button_Keyboard_Up",
        108 => "Button_Keyboard_LCtrl",
        109 => "Button_Keyboard_LShift",
        110 => "Button_Keyboard_LAlt",
        111 => "Button_Keyboard_LMeta",
        112 => "Button_Keyboard_RCtrl",
        113 => "Button_Keyboard_RShift",
        114 => "Button_Keyboard_RAlt",
        115 => "Button_Keyboard_RMeta",
        117 => "Button_Mouse_Left",
        118 => "Button_Mouse_Middle",
        119 => "Button_Mouse_Right",
        120 => "Button_Mouse_X1",
        121 => "Button_Mouse_X2",
        122 => "Button_Mouse_X",
        123 => "Button_Mouse_Y",
        124 => "Button_Mouse_ScrollX",
        125 => "Button_Mouse_ScrollY",
        126 => "Button_Gamepad_A",
        127 => "Button_Gamepad_B",
        128 => "Button_Gamepad_X",
        129 => "Button_Gamepad_Y",
        130 => "Button_Gamepad_Back",
        131 => "Button_Gamepad_Guide",
        132 => "Button_Gamepad_Start",
        133 => "Button_Gamepad_LStick",
        134 => "Button_Gamepad_RStick",
        135 => "Button_Gamepad_LBumper",
        136 => "Button_Gamepad_RBumper",
        137 => "Button_Gamepad_Up",
        138 => "Button_Gamepad_Down",
        139 => "Button_Gamepad_Left",
        140 => "Button_Gamepad_Right",
        141 => "Button_Gamepad_LTrigger",
        142 => "Button_Gamepad_RTrigger",
        143 => "Button_Gamepad_LStickX",
        144 => "Button_Gamepad_LStickY",
        145 => "Button_Gamepad_RStickX",
        146 => "Button_Gamepad_RStickY",
        147 => "Button_System_Exit",
        _ if button == Button_System_Win_Enter => "Button_System_Win_Enter",
        _ if button == Button_System_Win_Leave => "Button_System_Win_Leave",
        _ => {
            return format!("Unknown ({})", button);
        }
    }
    .into()
}
...
pub extern "C" fn Button_ToSDLScancode(button: Button) -> SDL_Scancode {
    match button {
        ...
        _ => {
            Fatal!("Button_ToSDLScancode: Unhandled case: {button}");
        }
    }
}
...
pub extern "C" fn Button_FromSDLMouseButton(mouseButton: u8) -> Button {
    match mouseButton as u32 {
        ...
        _ => {
            Fatal!("Button_FromSDLMouseButton: Unhandled case: {mouseButton}",);
        }
    }
}
...
pub extern "C" fn Button_ToSDLMouseButton(button: Button) -> u8 {
    match button {
        ...
        _ => {
            Fatal!("Button_ToSDLMouseButton: Unhandled case: {button}");
        }
    }
}
...
pub extern "C" fn Button_FromSDLControllerAxis(controllerAxis: SDL_GameControllerAxis) -> Button {
    match controllerAxis {
        ...
        _ => {
            Fatal!(
                "Button_FromSDLControllerAxis: Unhandled case: {}",
...
pub extern "C" fn Button_ToSDLControllerAxis(button: Button) -> SDL_GameControllerAxis {
    match button {
        ...
        _ => {
            Fatal!("Button_ToSDLControllerAxis: Unhandled case: {button}");
        }
    }
}
...
pub extern "C" fn Button_FromSDLControllerButton(
    ...
    match controllerButton {
        ...
        _ => {
            Fatal!(
                "Button_FromSDLControllerButton: Unhandled case: {}",
...
pub extern "C" fn Button_ToSDLControllerButton(button: Button) -> SDL_GameControllerButton {
    match button {
        ...
        _ => {
            Fatal!("Button_ToSDLControllerButton: Unhandled case: {button}");
        }
    }
}
