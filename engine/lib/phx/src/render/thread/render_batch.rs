...
use crate::render::{CameraRenderData, CmdPrimitiveType, EntityRenderData, GpuHandle};
...
impl RenderBatch {
    ...
    pub fn flush(&mut self, worker_pool: Option<&WorkerPoolHandle>) -> BatchStats {
        ...
        if let Some(pool) = worker_pool {
            ...
            let _frame_id = pool.submit_entities(entities, self.camera.clone());
            ...
            self.process_serial(&self.camera);
        }
...
impl RenderBatchApi {
    ...
    pub fn set_camera(
        ...
        let view = [
            view_00, view_01, view_02, view_03, view_10, view_11, view_12, view_13, view_20,
            view_21, view_22, view_23, view_30, view_31, view_32, view_33,
        ];
        let proj = [
            proj_00, proj_01, proj_02, proj_03, proj_10, proj_11, proj_12, proj_13, proj_20,
            proj_21, proj_22, proj_23, proj_30, proj_31, proj_32, proj_33,
        ];
        RENDER_BATCH.with(|batch| {
            batch
                .borrow_mut()
                .set_camera(&view, &proj, eye_x, eye_y, eye_z);
        });
    }
