...
impl FMOD_RESULT {
    pub fn error_string(&self) -> &'static str {
        match self {
            ...
            FMOD_RESULT::FMOD_ERR_DSP_DONTPROCESS => "DSP return code from a DSP process query callback.  Tells mixer not to call the process callback and therefore not consume CPU.  Use this to optimize the DSP graph.",
            ...
            FMOD_RESULT::FMOD_ERR_DSP_SILENCE => "DSP return code from a DSP process query callback.  Tells mixer silence would be produced from read, so go idle and not consume CPU.  Use this to optimize the DSP graph.",
            ...
            FMOD_RESULT::FMOD_ERR_INTERNAL => "An error occurred that wasn't supposed to.  Contact support.",
            ...
            FMOD_RESULT::FMOD_ERR_PLUGIN => "An unspecified error has been returned from a plugin.",
