...
typedef struct RawButton RawButton;
struct RawButton {
  Button button;
  float  value;
};

typedef struct AggregateButton AggregateButton;
...
typedef struct AggregateAxis AggregateAxis;
...
typedef struct AggregateAxis2D AggregateAxis2D;
...
typedef struct DownBinding DownBinding;
struct DownBinding {
