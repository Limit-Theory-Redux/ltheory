...
#define DEF_CubeFace_PX GL_TEXTURE_CUBE_MAP_POSITIVE_X
#define DEF_CubeFace_NX GL_TEXTURE_CUBE_MAP_NEGATIVE_X
#define DEF_CubeFace_PY GL_TEXTURE_CUBE_MAP_POSITIVE_Y
#define DEF_CubeFace_NY GL_TEXTURE_CUBE_MAP_NEGATIVE_Y
#define DEF_CubeFace_PZ GL_TEXTURE_CUBE_MAP_POSITIVE_Z
#define DEF_CubeFace_NZ GL_TEXTURE_CUBE_MAP_NEGATIVE_Z

static Face kFaces[6] = {
  { DEF_CubeFace_PX, { 1,  0,  0}, {0, 1,  0} },
  { DEF_CubeFace_NX, {-1,  0,  0}, {0, 1,  0} },
  { DEF_CubeFace_PY, { 0,  1,  0}, {0, 0, -1} },
  { DEF_CubeFace_NY, { 0, -1,  0}, {0, 0,  1} },
  { DEF_CubeFace_PZ, { 0,  0,  1}, {0, 1,  0} },
  { DEF_CubeFace_NZ, { 0,  0, -1}, {0, 1,  0} },
};
