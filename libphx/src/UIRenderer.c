...
typedef struct UIRendererImage UIRendererImage;
...
typedef struct UIRendererPanel UIRendererPanel;
...
typedef struct UIRendererRect UIRendererRect;
...
typedef struct UIRendererText UIRendererText;
...
typedef struct UIRendererLayer UIRendererLayer;
