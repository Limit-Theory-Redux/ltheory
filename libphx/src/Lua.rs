    ...
    loop {
        ...
        if (stack_capacity == stack_size) as libc::c_int as libc::c_long != 0 {
            ...
            *pData = MemRealloc(
                ...
                (stack_capacity as libc::c_ulong).wrapping_mul(elemSize),
            );
        }
        ...
        *fresh5 = stackFrame;
        ...
        loop {
            ...
            if iUp == 1 as libc::c_int {
                if (stack_capacity == stack_size) as libc::c_int as libc::c_long != 0 {
                    ...
                    *pData_0 = MemRealloc(
                        stack_data as *mut libc::c_void,
                        (stack_capacity as libc::c_ulong).wrapping_mul(elemSize_0),
                    );
                }
            ...
            if (stack_capacity == stack_size) as libc::c_int as libc::c_long != 0 {
                ...
                *pData_1 = MemRealloc(
                    stack_data as *mut libc::c_void,
                    (stack_capacity as libc::c_ulong).wrapping_mul(elemSize_1),
                );
            }
        ...
        loop {
            ...
            if iLocal == 1 as libc::c_int {
                if (stack_capacity == stack_size) as libc::c_int as libc::c_long != 0 {
                    ...
                    *pData_2 = MemRealloc(
                        stack_data as *mut libc::c_void,
                        (stack_capacity as libc::c_ulong).wrapping_mul(elemSize_2),
                    );
                }
            ...
            if (stack_capacity == stack_size) as libc::c_int as libc::c_long != 0 {
                ...
                *pData_3 = MemRealloc(
                    stack_data as *mut libc::c_void,
                    (stack_capacity as libc::c_ulong).wrapping_mul(elemSize_3),
                );
            }
        ...
        if variablesPrinted > 0 as libc::c_int {
            if (stack_capacity == stack_size) as libc::c_int as libc::c_long != 0 {
                ...
                *pData_4 = MemRealloc(
                    stack_data as *mut libc::c_void,
                    (stack_capacity as libc::c_ulong).wrapping_mul(elemSize_4),
                );
            }
