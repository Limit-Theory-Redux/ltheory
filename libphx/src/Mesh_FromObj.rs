...
pub unsafe extern "C" fn Mesh_FromObj(mut bytes: cstr) -> *mut Mesh {
        ...
        as libc::c_int as libc::c_long != 0
    {
        ...
        *pData = MemRealloc(
            ...
            (positions_capacity as libc::c_ulong).wrapping_mul(elemSize),
        );
    }
        ...
        as libc::c_long != 0
    {
        ...
        *pData_0 = MemRealloc(
            ...
            (uvs_capacity as libc::c_ulong).wrapping_mul(elemSize_0),
        );
    }
        ...
        as libc::c_int as libc::c_long != 0
    {
        ...
        *pData_1 = MemRealloc(
            ...
            (normals_capacity as libc::c_ulong).wrapping_mul(elemSize_1),
        );
    }
    ...
    loop {
        ...
        if StrEqual(
            ...
            if (positions_capacity == positions_size) as libc::c_int as libc::c_long != 0
            {
                ...
                *pData_2 = MemRealloc(
                    positions_data as *mut libc::c_void,
                    (positions_capacity as libc::c_ulong).wrapping_mul(elemSize_2),
                );
            }
            ...
            *positions_data.offset(fresh1 as isize) = p;
            ...
            if (uvs_capacity == uvs_size) as libc::c_int as libc::c_long != 0 {
                ...
                *pData_3 = MemRealloc(
                    uvs_data as *mut libc::c_void,
                    (uvs_capacity as libc::c_ulong).wrapping_mul(elemSize_3),
                );
            }
            let fresh2 = uvs_size;
            uvs_size = uvs_size + 1;
            *uvs_data.offset(fresh2 as isize) = uv;
            ...
            if (normals_capacity == normals_size) as libc::c_int as libc::c_long != 0 {
                ...
                *pData_4 = MemRealloc(
                    normals_data as *mut libc::c_void,
                    (normals_capacity as libc::c_ulong).wrapping_mul(elemSize_4),
                );
            }
