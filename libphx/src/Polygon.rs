        ...
        if bSide as libc::c_int == 1 as libc::c_int {
            ...
            *((*front).vertices_data).offset(fresh2 as isize) = b;
                ...
                as libc::c_long != 0
            {
                ...
                *pData_5 = MemRealloc(
                    (*back).vertices_data as *mut libc::c_void,
                    ((*back).vertices_capacity as libc::c_ulong).wrapping_mul(elemSize_5),
                );
            }
...
pub unsafe extern "C" fn Polygon_SplitSafe(
    ...
    while i
        < (::core::mem::size_of::<[*mut Polygon; 2]>() as libc::c_ulong)
            .wrapping_div(::core::mem::size_of::<*mut Polygon>() as libc::c_ulong)
            as libc::c_int
    {
            ...
            *triangles_data = MemRealloc(
                *triangles_data as *mut libc::c_void,
                (*triangles_capacity as libc::c_ulong)
                    .wrapping_mul(::core::mem::size_of::<Triangle>() as libc::c_ulong),
            ) as *mut Triangle;
        }
