...
pub unsafe extern "C" fn InputBindings_Init() {
        ...
        as libc::c_long != 0
    {
        ...
        let mut elemSize: size_t = ::core::mem::size_of::<InputBinding>()
            as libc::c_ulong;
        ...
        *pData = MemRealloc(
            ...
            (self_0.activeBindings_capacity as libc::c_ulong).wrapping_mul(elemSize),
        );
    }
        ...
        != 0
    {
        ...
        let mut elemSize_0: size_t = ::core::mem::size_of::<DownBinding>()
            as libc::c_ulong;
        ...
        *pData_0 = MemRealloc(
            ...
            (self_0.downBindings_capacity as libc::c_ulong).wrapping_mul(elemSize_0),
        );
    }
}
#[no_mangle]
...
pub unsafe extern "C" fn InputBindings_UpdateBinding(mut binding: *mut InputBinding) {
    ...
    while iAxis
        < (::core::mem::size_of::<[AggregateAxis; 2]>() as libc::c_ulong)
            .wrapping_div(::core::mem::size_of::<AggregateAxis>() as libc::c_ulong)
            as libc::c_int
    {
    ...
    while iBtn
        < (::core::mem::size_of::<[AggregateButton; 4]>() as libc::c_ulong)
            .wrapping_div(::core::mem::size_of::<AggregateButton>() as libc::c_ulong)
            as libc::c_int
    {
        ...
        if !((*button).state & State_Down == State_Down) {
            ...
            } != 0
            {
                    ...
                    as libc::c_int as libc::c_long != 0
                {
                    ...
                    let mut elemSize: size_t = ::core::mem::size_of::<DownBinding>()
                        as libc::c_ulong;
                    let mut pData: *mut *mut libc::c_void = &mut self_0.downBindings_data
                        as *mut *mut DownBinding as *mut *mut libc::c_void;
                    *pData = MemRealloc(
                        self_0.downBindings_data as *mut libc::c_void,
                        (self_0.downBindings_capacity as libc::c_ulong)
...
pub unsafe extern "C" fn InputBindings_Update() {
    ...
    while Input_GetNextEvent(&mut event) {
        ...
        while binding >= __iterbegin {
            let mut iBtn: libc::c_int = 0 as libc::c_int;
            while iBtn
                < (::core::mem::size_of::<[[RawButton; 4]; 4]>() as libc::c_ulong)
                    .wrapping_div(
                        ::core::mem::size_of::<[RawButton; 4]>() as libc::c_ulong,
                    ) as libc::c_int
            {
                let mut iBind: libc::c_int = 0 as libc::c_int;
                while iBind
                    < (::core::mem::size_of::<[RawButton; 4]>() as libc::c_ulong)
                        .wrapping_div(
                            ::core::mem::size_of::<RawButton>() as libc::c_ulong,
                        ) as libc::c_int
                {
