...
fn _cppRigidBody_ApplyForce(this: *mut RigidBody, force: *mut Vec3f);
fn _cppRigidBody_ApplyTorque(this: *mut RigidBody, torque: *mut Vec3f);
fn _cppRigidBody_Attach(this: *mut RigidBody, other: *mut RigidBody, offset: *mut Vec3f, rot: *mut Quat);
...
fn _cppRigidBody_GetVelocity(this: *mut RigidBody, out: *mut Vec3f);
fn _cppRigidBody_GetVelocityA(this: *mut RigidBody, out: *mut Vec3f);
...
fn _cppRigidBody_GetPos(this: *mut RigidBody, out: *mut Vec3f);
fn _cppRigidBody_GetPosLocal(this: *mut RigidBody, out: *mut Vec3f);
fn _cppRigidBody_SetPos(this: *mut RigidBody, pos: *mut Vec3f);
fn _cppRigidBody_SetPosLocal(this: *mut RigidBody, pos: *mut Vec3f);
...
#[no_mangle]
pub unsafe extern "C" fn RigidBody_ApplyForce(this: *mut RigidBody, force: *mut Vec3f) {
    _cppRigidBody_ApplyForce(this, force)
}

#[no_mangle]
pub unsafe extern "C" fn RigidBody_ApplyTorque(this: *mut RigidBody, torque: *mut Vec3f) {
    _cppRigidBody_ApplyTorque(this, torque)
}

#[no_mangle]
pub unsafe extern "C" fn RigidBody_Attach(this: *mut RigidBody, other: *mut RigidBody, offset: *mut Vec3f, rot: *mut Quat) {
...
#[no_mangle]
pub unsafe extern "C" fn RigidBody_GetVelocity(this: *mut RigidBody, out: *mut Vec3f) {
    _cppRigidBody_GetVelocity(this, out)
}

#[no_mangle]
pub unsafe extern "C" fn RigidBody_GetVelocityA(this: *mut RigidBody, out: *mut Vec3f) {
...
#[no_mangle]
pub unsafe extern "C" fn RigidBody_GetPos(this: *mut RigidBody, out: *mut Vec3f) {
    _cppRigidBody_GetPos(this, out)
}

#[no_mangle]
pub unsafe extern "C" fn RigidBody_GetPosLocal(this: *mut RigidBody, out: *mut Vec3f) {
    _cppRigidBody_GetPosLocal(this, out)
}

#[no_mangle]
pub unsafe extern "C" fn RigidBody_SetPos(this: *mut RigidBody, pos: *mut Vec3f) {
    _cppRigidBody_SetPos(this, pos)
}

#[no_mangle]
pub unsafe extern "C" fn RigidBody_SetPosLocal(this: *mut RigidBody, pos: *mut Vec3f) {
