...
extern "C" {
    ...
    fn __fpclassifyl(_: f128::f128) -> libc::c_int;
...
pub unsafe extern "C" fn Mesh_Create() -> *mut Mesh {
    let mut self_0: *mut Mesh = MemAlloc(::core::mem::size_of::<Mesh>() as libc::c_ulong)
        as *mut Mesh;
...
pub unsafe extern "C" fn Mesh_Clone(mut other: *mut Mesh) -> *mut Mesh {
        ...
        != 0
    {
        ...
        *pData = MemRealloc(
            ...
            ((*self_0).index_capacity as libc::c_ulong).wrapping_mul(elemSize),
        );
    }
        ...
        != 0
    {
        ...
        *pData_0 = MemRealloc(
            ...
            ((*self_0).vertex_capacity as libc::c_ulong).wrapping_mul(elemSize_0),
        );
    }
...
pub unsafe extern "C" fn Mesh_ToBytes(mut mesh: *mut Mesh) -> *mut Bytes {
    ...
    let mut size: uint32 = (2 as libc::c_int as libc::c_ulong)
        ...
        .wrapping_add(
            (vertexCount as libc::c_ulong)
                .wrapping_mul(::core::mem::size_of::<Vertex>() as libc::c_ulong),
        )
        .wrapping_add(
    ...
    Bytes_Write(
        ...
        (vertexCount as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<Vertex>() as libc::c_ulong) as uint32,
    );
    Bytes_Write(
        self_0,
        (*mesh).index_data as *const libc::c_void,
        (indexCount as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<int32>() as libc::c_ulong) as uint32,
    );
    return self_0;
}
#[no_mangle]
...
pub unsafe extern "C" fn Mesh_AddVertex(
        ...
        as libc::c_long != 0
    {
        ...
        *pData = MemRealloc(
            (*self_0).vertex_data as *mut libc::c_void,
            ((*self_0).vertex_capacity as libc::c_ulong).wrapping_mul(elemSize),
        );
    }
