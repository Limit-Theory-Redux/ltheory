...
#[no_mangle]
pub static mut Modifier_Null: Modifier = 0;
#[no_mangle]
pub static mut Modifier_Alt: Modifier = 0;
#[no_mangle]
pub static mut Modifier_Ctrl: Modifier = 0;
#[no_mangle]
pub static mut Modifier_Shift: Modifier = 0;
#[inline]
...
unsafe extern "C" fn Input_EnsureDeviceState(mut device: Device) -> *mut DeviceState {
    ...
    while (*deviceList).devices_size as uint32 <= device.id {
            ...
            as libc::c_long != 0
        {
            ...
            let mut elemSize: size_t = ::core::mem::size_of::<DeviceState>()
                as libc::c_ulong;
            ...
            *pData = MemRealloc(
                ...
                ((*deviceList).devices_capacity as libc::c_ulong).wrapping_mul(elemSize),
            );
        }
...
unsafe extern "C" fn Input_AppendEvent(mut event: InputEvent) {
    ...
    if (self_0.events_capacity == self_0.events_size) as libc::c_int as libc::c_long != 0
    {
        ...
        let mut elemSize: size_t = ::core::mem::size_of::<InputEvent>() as libc::c_ulong;
        ...
        *pData = MemRealloc(
            ...
            (self_0.events_capacity as libc::c_ulong).wrapping_mul(elemSize),
        );
    }
...
unsafe extern "C" fn Input_InjectEvent(mut event: InputEvent) {
        ...
        as libc::c_long != 0
    {
        ...
        *pData = MemRealloc(
            ...
            (self_0.injectedEvents_capacity as libc::c_ulong).wrapping_mul(elemSize),
        );
    }
...
unsafe extern "C" fn Input_SetButton(mut event: InputEvent) {
    ...
    if !down && event.state & State_Pressed == State_Pressed {
            ...
            as libc::c_long != 0
        {
            ...
            let mut elemSize: size_t = ::core::mem::size_of::<InputEvent>()
                as libc::c_ulong;
            let mut pData: *mut *mut libc::c_void = &mut self_0.downButtons_data
                as *mut *mut InputEvent as *mut *mut libc::c_void;
            *pData = MemRealloc(
                self_0.downButtons_data as *mut libc::c_void,
                (self_0.downButtons_capacity as libc::c_ulong).wrapping_mul(elemSize),
            );
        }
        ...
        while i >= 0 as libc::c_int {
            if (*(self_0.downButtons_data).offset(i as isize)).button == event.button {
                if i != self_0.downButtons_size - 1 as libc::c_int {
                    ...
                    let mut elemSize_0: size_t = ::core::mem::size_of::<InputEvent>()
                        as libc::c_ulong;
                    MemMove(
                        curr,
                        next,
    ...
    if Button_IsAutoRelease(event.button) {
            ...
            as libc::c_long != 0
        {
            ...
            let mut elemSize_1: size_t = ::core::mem::size_of::<InputEvent>()
                as libc::c_ulong;
            let mut pData_0: *mut *mut libc::c_void = &mut self_0.autoRelease_data
                as *mut *mut InputEvent as *mut *mut libc::c_void;
            *pData_0 = MemRealloc(
                self_0.autoRelease_data as *mut libc::c_void,
                (self_0.autoRelease_capacity as libc::c_ulong).wrapping_mul(elemSize_1),
            );
        }
...
pub unsafe extern "C" fn Input_Init() {
        ...
        != 0
    {
        ...
        *pData_0 = MemRealloc(
            self_0.downButtons_data as *mut libc::c_void,
            (self_0.downButtons_capacity as libc::c_ulong).wrapping_mul(elemSize_0),
        );
    }
        ...
        as libc::c_long != 0
    {
        ...
        let mut elemSize_2: size_t = ::core::mem::size_of::<InputEvent>()
            as libc::c_ulong;
        let mut pData_2: *mut *mut libc::c_void = &mut self_0.injectedEvents_data
            as *mut *mut InputEvent as *mut *mut libc::c_void;
        *pData_2 = MemRealloc(
            self_0.injectedEvents_data as *mut libc::c_void,
            (self_0.injectedEvents_capacity as libc::c_ulong).wrapping_mul(elemSize_2),
        );
    }
    ...
    while iDev < 4 as libc::c_int {
        ...
        while deviceState < __iterend {
            MemSet(
                ...
                0 as libc::c_int,
                ::core::mem::size_of::<[int32; 512]>() as libc::c_ulong,
            );
...
pub unsafe extern "C" fn Input_GetKeyboardMod(mut modifier: Modifier) -> bool {
    ...
    if modifier & Modifier_Alt == Modifier_Alt {
        hasMod = (hasMod as libc::c_int & Input_GetKeyboardAlt() as libc::c_int) as bool;
    }
    ...
    *event = *(self_0.events_data).offset(0 as libc::c_int as isize);
    if 0 as libc::c_int != self_0.events_size - 1 as libc::c_int {
        ...
        MemMove(
            curr,
            next,
            ((self_0.events_size - 1 as libc::c_int - 0 as libc::c_int) as libc::c_ulong)
