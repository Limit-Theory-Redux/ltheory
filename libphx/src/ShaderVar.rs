...
#[no_mangle]
pub unsafe extern "C" fn ShaderVar_PushFloat2(mut name: *const libc::c_char, mut x: f32, mut y: f32) {
...
#[no_mangle]
pub unsafe extern "C" fn ShaderVar_PushFloat3(mut name: *const libc::c_char, mut x: f32, mut y: f32, mut z: f32) {
