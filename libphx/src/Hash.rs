...
pub unsafe extern "C" fn Hash_FNV32(
    ...
    while curr < end {
        ...
        curr = curr.offset(1);
        this ^= *fresh0 as u32;
        this = (this as u32).wrapping_mul(16777619 as u32)
            as u32;
    }
    return this;
}
...
pub unsafe extern "C" fn Hash_FNV64(
    ...
    while curr < end {
        ...
        this ^= *fresh1 as u64;
        this = (this as u64)
            .wrapping_mul(1099511628211 as u64) as u64;
    }
    return this;
}
#[no_mangle]
...
pub unsafe extern "C" fn Hash_Murmur3(
    ...
    let mut blocks: *const u32 = data.offset((nblocks * 4 as i32) as isize)
        as *const u32;
...
unsafe extern "C" fn XXH64_round(mut acc: u64, mut val: u64) -> u64 {
    acc = (acc as u64).wrapping_add(val.wrapping_mul(PRIME64_2)) as u64
        as u64;
...
pub unsafe extern "C" fn Hash_XX64(
    ...
    if len >= 32 as i32 {
        ...
        hash = (v1 << 1 as i32 | v1 >> 64 as i32 - 1 as i32)
            .wrapping_add(
                v2 << 7 as i32 | v2 >> 64 as i32 - 7 as i32,
            )
            .wrapping_add(
                v3 << 12 as i32 | v3 >> 64 as i32 - 12 as i32,
            )
            .wrapping_add(
                v4 << 18 as i32 | v4 >> 64 as i32 - 18 as i32,
            );
