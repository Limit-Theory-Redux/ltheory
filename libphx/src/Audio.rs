...
pub unsafe extern "C" fn Audio_AllocSoundDesc(mut name: cstr) -> *mut SoundDesc {
    ...
    if desc.is_null() {
        desc = MemAllocZero(::core::mem::size_of::<SoundDesc>() as libc::c_ulong)
            as *mut SoundDesc;
    ...
    if Sound_IsFreed(sound) {
            ...
            as libc::c_long != 0
        {
            ...
            *pData = MemRealloc(
                ...
                (self_0.freeingSounds_capacity as libc::c_ulong).wrapping_mul(elemSize),
            );
        }
        ...
        *fresh3 = sound;
            ...
            as libc::c_long != 0
        {
            ...
            *pData_0 = MemRealloc(
                ...
                (self_0.playingSounds_capacity as libc::c_ulong).wrapping_mul(elemSize_0),
            );
        }
