    ...
    if self_0.locked {
            ...
            as libc::c_long != 0
        {
            ...
            *pData = MemRealloc(
                ...
                (self_0.addQueue_capacity as libc::c_ulong).wrapping_mul(elemSize),
            );
        }
        ...
        *(self_0.addQueue_data).offset(fresh0 as isize) = elem;
            ...
            != 0
        {
            ...
            *pData_0 = MemRealloc(
                ...
                (self_0.elems_capacity as libc::c_ulong).wrapping_mul(elemSize_0),
            );
        }
...
unsafe extern "C" fn LuaScheduler_Update(mut L: *mut Lua) -> libc::c_int {
    ...
    while self_0.addQueue_size != 0 {
            ...
            != 0
        {
            ...
            *pData = MemRealloc(
                self_0.elems_data as *mut libc::c_void,
                (self_0.elems_capacity as libc::c_ulong).wrapping_mul(elemSize),
            );
        }
