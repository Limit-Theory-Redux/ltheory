...
#[no_mangle]
pub extern "C" fn Gamepad_GetButtonPressed(this: &mut Gamepad, button: GamepadButton) -> f64 {
...
#[no_mangle]
pub extern "C" fn Gamepad_GetButtonReleased(this: &mut Gamepad, button: GamepadButton) -> f64 {
