...
unsafe extern "C" fn Font_GetGlyph(
    ...
    g = MemAlloc(::core::mem::size_of::<Glyph>() as libc::c_ulong) as *mut Glyph;
    (*g).index = glyph;
    ...
    let mut buffer: *mut Vec4f = MemAlloc(
        (::core::mem::size_of::<Vec4f>() as libc::c_ulong)
...
pub unsafe extern "C" fn Font_Load(mut name: cstr, mut size: libc::c_int) -> *mut Font {
    ...
    let mut self_0: *mut Font = MemAlloc(::core::mem::size_of::<Font>() as libc::c_ulong)
        as *mut Font;
