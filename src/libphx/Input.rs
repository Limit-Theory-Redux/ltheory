...
unsafe extern "C" fn Input_AppendEvent(mut event: InputEvent) {
    ...
    if (self_0.events_capacity == self_0.events_size) as libc::c_int as libc::c_long != 0
    {
        ...
        *pData = MemRealloc(
            ...
            (self_0.events_capacity as usize).wrapping_mul(elemSize),
        );
    }
...
unsafe extern "C" fn Input_InjectEvent(mut event: InputEvent) {
        ...
        as libc::c_long != 0
    {
        ...
        *pData = MemRealloc(
            ...
            (self_0.injectedEvents_capacity as usize).wrapping_mul(elemSize),
        );
    }
    ...
    if !down && event.state & State_Pressed == State_Pressed {
            ...
            as libc::c_long != 0
        {
            ...
            *pData = MemRealloc(
                ...
                (self_0.downButtons_capacity as usize).wrapping_mul(elemSize),
            );
        }
    ...
    if Button_IsAutoRelease(event.button) {
            ...
            as libc::c_long != 0
        {
            ...
            *pData_0 = MemRealloc(
                ...
                (self_0.autoRelease_capacity as usize).wrapping_mul(elemSize_1),
            );
        }
...
pub unsafe extern "C" fn Input_Init() {
        ...
        != 0
    {
        ...
        *pData_0 = MemRealloc(
            self_0.downButtons_data as *mut libc::c_void,
            (self_0.downButtons_capacity as usize).wrapping_mul(elemSize_0),
        );
    }
        ...
        as libc::c_long != 0
    {
        ...
        *pData_2 = MemRealloc(
            self_0.injectedEvents_data as *mut libc::c_void,
            (self_0.injectedEvents_capacity as usize).wrapping_mul(elemSize_2),
        );
    }
