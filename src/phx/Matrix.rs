...
#[no_mangle]
pub unsafe extern "C" fn Matrix_Equal(a: &Matrix, b: &Matrix) -> bool {
    let mut i: i32 = 0;
    while i < 16 {
...
#[no_mangle]
pub unsafe extern "C" fn Matrix_ApproximatelyEqual(a: &Matrix, b: &Matrix) -> bool {
    let mut i: i32 = 0;
    while i < 16 {
...
#[no_mangle]
pub unsafe extern "C" fn Matrix_Sum(a: &Matrix, b: &Matrix) -> Box<Matrix> {
    let mut result: Matrix = Matrix { m: [0.; 16] };
    let mut i: i32 = 0;
    while i < 16 {
...
#[no_mangle]
pub unsafe extern "C" fn Matrix_Identity() -> Box<Matrix> {
...
#[no_mangle]
pub unsafe extern "C" fn Matrix_LookAt(pos: &Vec3, at: &Vec3, up: &Vec3) -> Box<Matrix> {
...
#[no_mangle]
pub unsafe extern "C" fn Matrix_LookUp(pos: &Vec3, look: &Vec3, up: &Vec3) -> Box<Matrix> {
...
#[no_mangle]
pub unsafe extern "C" fn Matrix_RotationX(rads: f32) -> Box<Matrix> {
...
#[no_mangle]
pub unsafe extern "C" fn Matrix_RotationY(rads: f32) -> Box<Matrix> {
    let c: f32 = f64::cos(rads as f64) as f32;
    let s: f32 = f64::sin(rads as f64) as f32;
    let mut result: Matrix = Matrix {
        m: [
...
#[no_mangle]
pub unsafe extern "C" fn Matrix_RotationZ(rads: f32) -> Box<Matrix> {
    let c: f32 = f64::cos(rads as f64) as f32;
    let s: f32 = f64::sin(rads as f64) as f32;
    let mut result: Matrix = Matrix {
        m: [
...
#[no_mangle]
pub unsafe extern "C" fn Matrix_Scaling(sx: f32, sy: f32, sz: f32) -> Box<Matrix> {
    let mut result: Matrix = Matrix {
        m: [
...
#[no_mangle]
pub unsafe extern "C" fn Matrix_Translation(tx: f32, ty: f32, tz: f32) -> Box<Matrix> {
    let mut result: Matrix = Matrix {
        m: [
...
#[no_mangle]
pub unsafe extern "C" fn Matrix_YawPitchRoll(yaw: f32, pitch: f32, roll: f32) -> Box<Matrix> {
...
#[no_mangle]
pub unsafe extern "C" fn Matrix_GetForward(this: &Matrix, out: &mut Vec3) {
    out.x = -this.m[2];
    out.y = -this.m[6];
    out.z = -this.m[10];
}
...
#[no_mangle]
pub unsafe extern "C" fn Matrix_GetRight(this: &Matrix, out: &mut Vec3) {
    out.x = this.m[0];
    out.y = this.m[4];
    out.z = this.m[8];
}
...
#[no_mangle]
pub unsafe extern "C" fn Matrix_GetUp(this: &Matrix, out: &mut Vec3) {
    out.x = this.m[1];
    out.y = this.m[5];
    out.z = this.m[9];
}
...
#[no_mangle]
pub unsafe extern "C" fn Matrix_GetPos(this: &Matrix, out: &mut Vec3) {
    out.x = this.m[3];
    out.y = this.m[7];
    out.z = this.m[11];
}
...
#[no_mangle]
pub unsafe extern "C" fn Matrix_GetRow(this: &Matrix, out: &mut Vec4, row: i32) {
...
#[no_mangle]
pub unsafe extern "C" fn Matrix_FromBasis(x: &Vec3, y: &Vec3, z: &Vec3) -> Box<Matrix> {
    let mut result: Matrix = Matrix {
        m: [
...
#[no_mangle]
pub unsafe extern "C" fn Matrix_FromPosRot(pos: &Vec3, rot: &Quat) -> Box<Matrix> {
    let mut x = Vec3::ZERO;
...
#[no_mangle]
pub unsafe extern "C" fn Matrix_FromPosRotScale(pos: &Vec3, rot: &Quat, scale: f32) -> Box<Matrix> {
    let mut x = Vec3::ZERO;
    Quat_GetAxisX(rot, &mut x);
    let mut y = Vec3::ZERO;
    Quat_GetAxisY(rot, &mut y);
...
#[no_mangle]
pub unsafe extern "C" fn Matrix_FromQuat(q: &Quat) -> Box<Matrix> {
    let mut x = Vec3::ZERO;
...
#[no_mangle]
pub unsafe extern "C" fn Matrix_ToString(this: &Matrix) -> *const libc::c_char {
    let m = &this.m;
